function captureUserMedia(mediaConstraints, successCallback, errorCallback) {
            ...
            /*document.querySelector('#training-recording #stop-recording').onclick = function() {
                this.disabled = true;
                mediaRecorder.stop();
                mediaRecorder.stream.stop();
                document.querySelector('#training-recording #start-recording').disabled = false;
            };
            document.querySelector('#training-recording #save-recording').onclick = function() {
                this.disabled = true;
                mediaRecorder.save();
            };*/
            ...
            function onMediaSuccess(stream) {
                ...
                var timeInterval = 3 * 1000 // 30 * 1000
